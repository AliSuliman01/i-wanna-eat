...
class CreateRegionTypeTranslationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        try{
            Schema::create('region_type_translation', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('region_type_translation');
    }
}
